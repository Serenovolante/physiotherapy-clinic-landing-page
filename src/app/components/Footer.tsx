          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="tel:+919211581728" className="text-sm hover:text-white transition-colors text-[#000000]">+91 92115 81728</a>
              </div>
              <div className="flex items-center gap-2.5">
                <Mail size={15} className="shrink-0" style={{ color: "#0D9488" }} />
                <a href="mailto:hello@nvsportsphysio.com" className="text-sm hover:text-white transition-colors text-[#000000]">hello@nvsportsphysio.com</a>
              </div>
            </div>
          </div>
