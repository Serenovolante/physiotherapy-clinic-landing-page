        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 w-full items-center">
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-5">
              ...
              >
                Expert
                <span className="block" style={{ color: "#0D9488" }}>Physiotherapy</span>
                <span className="block">Care at Clinic or Your Home</span>
              </h1>
              <p className="text-xl lg:text-2xl text-gray-500 font-normal max-w-md" style={{ lineHeight: "1.6" }}>
                Pain relief, recovery, and mobility improvement tailored for you.
              </p>
            </div>
